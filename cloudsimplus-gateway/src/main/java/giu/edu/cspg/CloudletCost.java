...
public class CloudletCost {
     ...
     */
    public CloudletCost(final Cloudlet cloudlet, Map<Long, Double> cloudletArrivalTimeMap) {
     ...
     *
     * <p>
     * This cost is calculated based on the Cloudlet's total execution time
    ...
    public double getProcessingCost() {
        ...
        final double totalWaitTime = Math
                .ceil(cloudlet.getStartTime() - cloudletArrivalTimeMap.get(cloudlet.getId()));
        final double cloudletTotalTime = cloudlet.getTotalExecutionTime() + totalWaitTime;
